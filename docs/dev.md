# Documentation and Developer Guide For Blueprint's DREAM app!
## Setup
...
```
3. Create a GitHub issue for your feature in the DREAM repository so that other
...
request itself).
8. Rinse and repeat! Thank you for contributing to DREAM!
